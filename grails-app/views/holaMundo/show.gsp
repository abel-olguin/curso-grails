...
<html>
    ...
    <body>
        ...
        <div id="show-holaMundo" class="content scaffold-show" role="main">
            ...
            <f:display bean="holaMundo" />
            <g:form resource="${this.holaMundo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.holaMundo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
